...
axios.put('https://backend-2-i7cd.onrender.com/putnote',profill).then((res)=>{
alert(res.data.msg)
...
<h1>upload notice</h1>
        ...
        <div id="notdiv"  >
            ...
            <textarea id="texdiv" style={{fontSize:"16px"}} onChange={(e)=>getnote({...note,discription:e.target.value})} required>
